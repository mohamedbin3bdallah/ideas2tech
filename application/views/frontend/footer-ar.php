    ...
    <div class="container">
		...
		<div class="col-md-3 col-xs-6">
            <ul class="list-unstyled">
                ...
                <li><a href="<?php echo base_url(); ?>about-ar">من نحن</a></li>
                <li><a href="<?php echo base_url(); ?>services-ar">خدماتنا</a></li>
                <li><a href="<?php echo base_url(); ?>projects-ar">مشارعنا</a></li>
                <li><a href="#">اطلب الان</a></li>
            </ul>
        </div>
		...
		<div class="col-md-3 col-xs-6">
            <ul class="list-unstyled">
                <li>الدعم</li>
                <li><a href="<?php echo base_url(); ?>faqs-ar">الاسئلة الشائعة</a></li>
