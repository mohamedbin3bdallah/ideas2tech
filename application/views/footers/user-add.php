		...
		$(document).ready(function(){
			$("#name").focusout(function() {
				...
				if(!val)
				{
					...
					$("#name_validation").html('<?php echo lang('required'); ?>');
					...
					$.ajax({
						...
						success: function (response) {
							...
							else if(response == 5)
							{
								$("#name").css("background-color", "#F5A9A9");
								$("#name_validation").css("color", "red");
								$("#name_validation").html('<?php echo lang('no_number'); ?>');
								$("#name_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 2)
							{
								$("#name").css("background-color", "#F5A9A9");
								$("#name_validation").css("color", "red");
								$("#name_validation").html('<?php echo lang('more_than_5_chars'); ?>');
								$("#name_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 3)
							{
								$("#name").css("background-color", "#F5A9A9");
								$("#name_validation").css("color", "red");
								$("#name_validation").html('<?php echo lang('less_than_255_chars'); ?>');
								$("#name_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 4)
							{
								$("#name").css("background-color", "#F5A9A9");
								$("#name_validation").css("color", "red");
								$("#name_validation").html('<?php echo lang('not_available'); ?>');
								$("#name_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 1)
							{
								...
								$("#name_validation").html('<?php echo lang('available'); ?>');
		...
		$(document).ready(function(){
			$("#email").focusout(function() {
				...
				if(!val)
				{
					...
					$("#email_validation").html('<?php echo lang('required'); ?>');
					...
					$.ajax({
						...
						success: function (response) {
							...
							else if(response == 2)
							{
								$("#email").css("background-color", "#F5A9A9");
								$("#email_validation").css("color", "red");
								$("#email_validation").html('<?php echo lang('not_correct_input'); ?>');
								$("#email_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 4)
							{
								$("#email").css("background-color", "#F5A9A9");
								$("#email_validation").css("color", "red");
								$("#email_validation").html('<?php echo lang('not_available'); ?>');
								$("#email_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 1)
							{
								...
								$("#email_validation").html('<?php echo lang('available'); ?>');
		...
		$(document).ready(function(){
			$("#password").focusout(function() {
				...
				if(!val1)
				{
					...
					$("#password_validation").html('<?php echo lang('required'); ?>');
					...
					$.ajax({
						...
						success: function (response) {
							...
							else if(response == 2)
							{
								$("#password").css("background-color", "#F5A9A9");
								$("#password_validation").css("color", "red");
								$("#password_validation").html('<?php echo lang('more_than_5_chars'); ?>');
								$("#password_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 3)
							{
								$("#password").css("background-color", "#F5A9A9");
								$("#password_validation").css("color", "red");
								$("#password_validation").html('<?php echo lang('less_than_255_chars'); ?>');
								$("#password_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 4)
							{
								...
								$("#cnfpassword_validation").html('<?php echo lang('not_equals'); ?>');
		...
		$(document).ready(function(){
			$("#cnfpassword").focusout(function() {
				...
				if(!val2)
				{
					$("#cnfpassword").css("background-color", "#F5A9A9");
					$("#cnfpassword_validation").css("color", "red");
					$("#cnfpassword_validation").html('<?php echo lang('required'); ?>');
					$("#cnfpassword_validation_h").val('0');
					$("#submit").attr('disabled', 'true');
				}
				else
		...
		$(document).ready(function(){
			$("#username").focusout(function() {
				...
				if(!val)
				{
					...
					$("#username_validation").html('<?php echo lang('required'); ?>');
					...
					$.ajax({
						...
						success: function (response) {
							...
							else if(response == 2)
							{
								$("#username").css("background-color", "#F5A9A9");
								$("#username_validation").css("color", "red");
								$("#username_validation").html('<?php echo lang('small_chars'); ?>');
								$("#username_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 3)
							{
								$("#username").css("background-color", "#F5A9A9");
								$("#username_validation").css("color", "red");
								$("#username_validation").html('<?php echo lang('more_than_5_chars'); ?>');
								$("#username_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 5)
							{
								$("#username").css("background-color", "#F5A9A9");
								$("#username_validation").css("color", "red");
								$("#username_validation").html('<?php echo lang('less_than_255_chars'); ?>');
								$("#username_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 4)
							{
								$("#username").css("background-color", "#F5A9A9");
								$("#username_validation").css("color", "red");
								$("#username_validation").html('<?php echo lang('not_available'); ?>');
								$("#username_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 1)
							{
								...
								$("#username_validation").html('<?php echo lang('available'); ?>');
