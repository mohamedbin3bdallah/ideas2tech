					...
					?>
					  ...
					  <div class="form-group">
						<?php
							...
							echo form_label(lang('addressen'),'addressen',$data);
						?>
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							$data = array(
								'name' => 'addressen',
								'id' => 'address',
								'placeholder' => lang('addressen'),
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => $contact->ctaddressen
							);
					  ...
					  <div class="form-group">
						<?php
							...
							echo form_label(lang('addressar'),'addressar',$data);
						?>
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							$data = array(
								'name' => 'addressar',
								'id' => 'address',
								'placeholder' => lang('addressar'),
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => $contact->ctaddressar
							);
							echo form_textarea($data);
						?>
                        </div>
