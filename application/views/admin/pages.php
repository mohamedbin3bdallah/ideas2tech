					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
						  ...
						  <th><?php echo lang('keywordsen'); ?></th>
						  <th><?php echo lang('keywordsar'); ?></th>
					  ...
					  <?php foreach($pages as $page) { ?>
                        <tr>
						  ...
						  <td><?php echo $page->pgtitleen; ?></td>
						  <td><?php echo $page->pgtitlear; ?></td>
						  <td><?php echo $page->pgdescen; ?></td>
						  <td><?php echo $page->pgdescar; ?></td>
						  <td><?php echo $page->pgkeywordsen; ?></td>
						  <td><?php echo $page->pgkeywordsar; ?></td>
