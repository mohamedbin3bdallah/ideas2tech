                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<input type="hidden" name="oldimg" value="<?php echo $slide->sdimg; ?>" />
                      <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('titleen'),'titleen',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'type' => 'text',								'name' => 'titleen',								'id' => 'title',								'placeholder' => lang('titleen'),								'class' => 'form-control col-md-7 col-xs-12',								//'max' => 255,								//'required' => 'required',								'value' => $slide->sdtitleen							);							echo form_input($data);						?>                        </div>                      </div>					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('titlear'),'titlear',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'type' => 'text',								'name' => 'titlear',								'id' => 'title',								'placeholder' => lang('titlear'),								'class' => 'form-control col-md-7 col-xs-12',								//'max' => 255,								//'required' => 'required',								'value' => $slide->sdtitlear							);							echo form_input($data);						?>                        </div>                      </div>					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('descen'),'descen',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'name' => 'descen',								'id' => 'desc',								'placeholder' => lang('descen'),								'class' => 'form-control col-md-7 col-xs-12',								'value' => $slide->sddescen							);							echo form_textarea($data);						?>                        </div>                      </div>					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('descar'),'descar',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'name' => 'descar',								'id' => 'desc',								'placeholder' => lang('descar'),								'class' => 'form-control col-md-7 col-xs-12',								'value' => $slide->sddescar							);							echo form_textarea($data);						?>                        </div>                      </div>					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('link'),'link',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'type' => 'text',								'name' => 'link',								'id' => 'link',								'placeholder' => lang('link'),								'class' => 'form-control col-md-7 col-xs-12',								//'max' => 255,								//'required' => 'required',								'value' => $slide->sdlinkurl							);							echo form_input($data);						?>                        </div>                      </div>
					  <!--<div class="form-group">
						<?php
							/*$data = array(
								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							if(isset($slide->sdimg) && $slide->sdimg != '' && file_exists($this->config->item('slides_folder').$slide->sdimg))
							{ 
								?><img src="<?php echo base_url().$this->config->item('slides_folder').$slide->sdimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $slide->sdimg
								);
