					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <?php foreach($abouts as $about) { ?>
                        <tr>
						  ...
						  <!--<td><?php //if(isset($about->abimg) && $about->abimg != '' && file_exists($this->config->item('about_folder').$about->abimg)) { ?><img src="<?php //echo base_url().$this->config->item('about_folder').$about->abimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;border-radius:15%;"/><?php //} ?></td>-->
