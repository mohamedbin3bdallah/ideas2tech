          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_product'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('products/editproduct/'.$product->prid, $attributes);
					?>
					...
					?>
					 ...
					 <?php if(in_array('CG',$this->sections)) { ?>
					  <div class="form-group">
						...
						<?php
							if(!empty($categories))
							{
								...
								echo form_dropdown('category', $ourtypes, set_value('category', $product->prcgid), 'id="category" class="form-control" required="required"');
							}
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							if(isset($product->primg) && $product->primg != '' && file_exists($this->config->item('products_folder').$product->primg))
							{ 
								?><img src="<?php echo base_url().$this->config->item('products_folder').$product->primg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $product->primg
								);
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							...
							if($product->practive == '1') $data['checked'] = 'TRUE';
