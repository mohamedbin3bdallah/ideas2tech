                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('aboutus/create', $attributes);
					?>
					...
					?>
                      ...
                      <div class="form-group">
						<?php
							...
							echo form_label(lang('title').lang('en').' <span class="required">*</span>','titleen',$data);
						?>
					  ...
					  <div class="form-group">
						<?php
							...
							echo form_label(lang('desc').lang('en').' <span class="required">*</span>','descen',$data);
						?>
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							$data = array(
					  ...
					  <?php
								...
								echo form_label(lang('icon'),'icon',$data);
							?>
							<div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
