          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_plan'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('plans/editplan/'.$plan->plid, $attributes);
					?>
					...
					<?php if(in_array('PL',$this->sections)) { ?>
					  <div class="form-group">
						...
						<?php
							if(!empty($categories))
							{
								...
								echo form_dropdown('category', $ourtypes, set_value('category', $plan->plcgid), 'id="category" class="form-control" required="required"');
							}
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							$data = array(
								...
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => htmlspecialchars_decode(stripslashes($plan->pldescen))
							);
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							$data = array(
								...
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => htmlspecialchars_decode(stripslashes($plan->pldescar))
							);
							echo form_textarea($data);
						?>
                        </div>
					  ...
					  <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('type', $ourtypes, array('type'=>$plan->pltype), 'id="type" class="form-control"');
						?>
                        </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							...
							if($plan->plactive == '1') $data['checked'] = 'TRUE';
